...
typedef struct {
  ...
  _boolean buffer_full;		/* Have we gotten an iMCU row from decoder? */
...
/*
 * Initialize mymain buffer controller.
 */

GLOBAL(void)
jinit_d_main_controller (j_decompress_ptr cinfo, _boolean need_full_buffer)
{
  my_main_ptr mymain;
