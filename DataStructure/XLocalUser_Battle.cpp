...
//					_XDWINPRINT("cooldown : %d  / elapsedtime : %d", m_EventSkillList.m_dwCooldownTime, g_LocalSystemTime - m_EventSkillList.m_dwCooldownStartTime);
					...
					TCHAR messagestring[256];
					sprintf(messagestring, _XGETINTERFACETEXT(ID_STRING_LOCALUSER_STARTSKILL), g_SkillProperty[m_EventSkillList.m_sSkillID]->skillName);
					g_NetworkKernel.InsertChatString(messagestring, _XDEF_CHATMESSAGECOLOR_SYSTEMGENERAL);
					m_EventSkillList.m_dwCooldownStartTime = 0;
				}
			}
						...
						case 5 :
							{
								...
								{
									TCHAR messagestring[128];
									sprintf(messagestring, "Active/Seq[%d] 상극일반 damage[%d]", m_CurrentAttackPoint-1, m_AttackResult.sDamage[m_CurrentAttackPoint-1]);	// add string
						...
						case 6 :
							{
								...
								{
									TCHAR messagestring[128];
									sprintf(messagestring, "Active/Seq[%d] 상극 크리 damage[%d]", m_CurrentAttackPoint-1, m_AttackResult.sDamage[m_CurrentAttackPoint-1]);		// add string
					...
					case 6 : 
						{
							...
							{
								TCHAR messagestring[128];
								sprintf(messagestring, "Active/Seq[%d] 상극크리 damage[%d]", m_CurrentAttackPoint-1, m_AttackResult.sDamage[m_CurrentAttackPoint-1]);	// add string
						...
						case 4 : 
							{
								...
								{
									TCHAR messagestring[128];
									sprintf(messagestring, "Charge SHOCK ");
			...
			if(m_ModelDescriptor.m_FrameResult & _XDEF_ACI_COMMANDFRAME)
			{
				...
				if(m_RegionDamageResult.bValid == TRUE)
				{
					if(m_SelectedSkillID == m_RegionDamageResult.nSkillID)
					{
						...
						int i = 0 ; for( ; i < m_RegionDamageResult.nObjectCnt ; ++i)
						{
							pMob = NULL;
							pUser = NULL;
						...
						case 4 : 
							{
								...
								{
									TCHAR messagestring[128];
									sprintf(messagestring, "Rounding SHOCK ");
                                #ifdef _XDEF_DAMAGECHATMESSAGE_080428_MAGVIPER // Author : 양희왕 //breif : 데미지 체팅 메시지 찍기 (대만은 안한다고 함 )
                                    g_NetworkKernel.InsertChatString(messagestring, _XDEF_CHATMESSAGECOLOR_NORMAL);
                                #endif
								}
						...
						case 4 : 
							{
								...
								{
									TCHAR messagestring[128];
									sprintf(messagestring, "Finish SHOCK ");
						...
						case 4 : 
							{
								...
								{
									TCHAR messagestring[128];
									sprintf(messagestring, "Smashing SHOCK ");
