...
void _XMeshObjectManager::disposeList( void )
{
	if( m_ModelList )
	{
		int i = 0 ; for(; i < m_ModelStackMaxCount; i++ )
		{
...
BOOL _XQuadTree::CreateTree( FLOAT worldsize, int objectcount, _XOctreeObject* objectlist )
{
	...
	// Set frumstum...
	int i = 0 ; for (; i < _XDEF_FRUSTUM_COUNT; i++) 
	{
