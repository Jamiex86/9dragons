========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : XPacker
========================================================================


AppWizard has created this XPacker application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your XPacker application.
...
res\XPacker.ico
    ...
    icon is included by the main resource file XPacker.rc.
...
XPackerDlg.h, XPackerDlg.cpp - the dialog
    These files contain your CXPackerDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in XPacker.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CXPackerDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named XPacker.pch and a precompiled types file named StdAfx.obj.
