...
//	m_FTPNoticeString = _T("아래의 옵션은 FTP에대한 세부설정입니다. \r\n필요시에만 설정하시고 가능한 기본설정을 사용하세요." );
}
...
void CFTPOptionsDialog::OnOK() 
{
	...
	_XRegWriteInt(ID_REGSTR_MASTERKEY, ID_REGSTR_INDYKEY, ID_REGSTR_USEHARDWARECURSOR, m_UseHardwareCursor );

	_XRegWriteInt(ID_REGSTR_MASTERKEY, ID_REGSTR_INDYKEY, ID_REGSTR_QUALITYLEVEL_TERRAIN, m_TextureQuality_Terrain );
	_XRegWriteInt(ID_REGSTR_MASTERKEY, ID_REGSTR_INDYKEY, ID_REGSTR_QUALITYLEVEL_WORLDOBJECT, m_TextureQuality_Building );
	_XRegWriteInt(ID_REGSTR_MASTERKEY, ID_REGSTR_INDYKEY, ID_REGSTR_QUALITYLEVEL_CHARACTER, m_TextureQuality_Character );
	_XRegWriteInt(ID_REGSTR_MASTERKEY, ID_REGSTR_INDYKEY, ID_REGSTR_QUALITYLEVEL_MONSTER, m_TextureQuality_Character );
	_XRegWriteInt(ID_REGSTR_MASTERKEY, ID_REGSTR_INDYKEY, ID_REGSTR_QUALITYLEVEL_NPC, m_TextureQuality_Character );
	
	_XRegWriteInt(ID_REGSTR_MASTERKEY, ID_REGSTR_INDYKEY, ID_REGSTR_MIPLEVEL_DETAILTTILE, m_MipLevel_Terrain );
	_XRegWriteInt(ID_REGSTR_MASTERKEY, ID_REGSTR_INDYKEY, ID_REGSTR_MIPLEVEL_WORLDOBJECT, m_MipLevel_Building );
	_XRegWriteInt(ID_REGSTR_MASTERKEY, ID_REGSTR_INDYKEY, ID_REGSTR_MIPLEVEL_CHARACTER, m_MipLevel_Character );
	
	_XRegWriteInt(ID_REGSTR_MASTERKEY, ID_REGSTR_INDYKEY, ID_REGSTR_QUALITYLEVEL_CHARACTERSHADOW, m_TextureQuality_Shadow );
	_XRegWriteInt(ID_REGSTR_MASTERKEY, ID_REGSTR_INDYKEY, ID_REGSTR_VIEWCHARACTERSHADOW, m_ViewCharacterShadow );
	_XRegWriteInt(ID_REGSTR_MASTERKEY, ID_REGSTR_INDYKEY, ID_REGSTR_VIEWCLOUDSHADOW, m_ViewCloudShadow );	

	_XRegWriteInt(ID_REGSTR_MASTERKEY, ID_REGSTR_INDYKEY, ID_REGSTR_SIGHTLEVEL_RANGE, m_SightRange );	

	_XRegWriteInt(ID_REGSTR_MASTERKEY, ID_REGSTR_INDYKEY, ID_REGSTR_ZDEPTHFORMAT, (m_ZBufferFormat == 0) ? 1 : 2 );
...
BOOL CFTPOptionsDialog::OnInitDialog() 
{
	...
	m_UseHardwareCursor			= _XRegReadInt(ID_REGSTR_MASTERKEY, ID_REGSTR_INDYKEY, ID_REGSTR_USEHARDWARECURSOR, 1, TRUE );
	
	m_TextureQuality_Terrain	= _XRegReadInt(ID_REGSTR_MASTERKEY, ID_REGSTR_INDYKEY, ID_REGSTR_QUALITYLEVEL_TERRAIN, 3, TRUE );
	m_TextureQuality_Building	= _XRegReadInt(ID_REGSTR_MASTERKEY, ID_REGSTR_INDYKEY, ID_REGSTR_QUALITYLEVEL_WORLDOBJECT, 3, TRUE );
	m_TextureQuality_Character	= _XRegReadInt(ID_REGSTR_MASTERKEY, ID_REGSTR_INDYKEY, ID_REGSTR_QUALITYLEVEL_CHARACTER, 3, TRUE );
	m_MipLevel_Terrain			= _XRegReadInt(ID_REGSTR_MASTERKEY, ID_REGSTR_INDYKEY, ID_REGSTR_MIPLEVEL_DETAILTTILE, 2, TRUE );
	m_MipLevel_Building			= _XRegReadInt(ID_REGSTR_MASTERKEY, ID_REGSTR_INDYKEY, ID_REGSTR_MIPLEVEL_WORLDOBJECT, 1, TRUE );
	m_MipLevel_Character		= _XRegReadInt(ID_REGSTR_MASTERKEY, ID_REGSTR_INDYKEY, ID_REGSTR_MIPLEVEL_CHARACTER, 1, TRUE );
	
	m_TextureQuality_Shadow		= _XRegReadInt(ID_REGSTR_MASTERKEY, ID_REGSTR_INDYKEY, ID_REGSTR_QUALITYLEVEL_CHARACTERSHADOW, 2, TRUE );
	m_ViewCharacterShadow		= _XRegReadInt(ID_REGSTR_MASTERKEY, ID_REGSTR_INDYKEY, ID_REGSTR_VIEWCHARACTERSHADOW, 1, TRUE );
	m_ViewCloudShadow			= _XRegReadInt(ID_REGSTR_MASTERKEY, ID_REGSTR_INDYKEY, ID_REGSTR_VIEWCLOUDSHADOW, 1, TRUE );	
	
	m_SightRange				= _XRegReadInt(ID_REGSTR_MASTERKEY, ID_REGSTR_INDYKEY, ID_REGSTR_SIGHTLEVEL_RANGE, 1, TRUE );
		
	m_ZBufferFormat				= _XRegReadInt(ID_REGSTR_MASTERKEY, ID_REGSTR_INDYKEY, ID_REGSTR_ZDEPTHFORMAT, 2, TRUE );
	m_ZBufferFormat				-= 1;
