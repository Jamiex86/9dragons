...
#if !defined(_XBrowser_defined)
#define _XBrowser_defined

#include "mshtml.h"

class _XBrowser : public CWnd {
...
public:
	...
	enum NotificationType {					// Note: _XBrowser does NOT support the
	...
	public:
		...
		NMHDR			hdr;				// hdr.hwndFrom = _XBrowser's HWND
											// hdr.idFrom   = _XBrowser's control ID
