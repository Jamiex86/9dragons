...
BOOL CSelectServer::OnInitDialog() 
{
	...
	m_ServerList.AddString( "±¸·æÀïÆÐ Á¤½Ä ¼­¹ö" );
	m_ServerList.AddString( "±¸·æÀïÆÐ Å×½ºÆ® ¼­¹ö" );
	m_SelectedServer = 1;
	UpdateData( FALSE );
...
void CSelectServer::OnDeltaposPatchnumberspin(NMHDR* pNMHDR, LRESULT* pResult) 
{
	...
	//_XRegWriteInt( ID_REGSTR_MASTERKEY, ID_REGSTR_INDYKEY, ID_REGSTR_PATCHNUMBER, m_PatchNumber );
