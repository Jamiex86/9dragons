...
{	
	...
	CString strSerialData = _T("");
	CString strSerialMergedtData = _T("A2FCFX3DQ4ISC1J9R3X2E");
	CString strEncryptKeyData = _T("9E2GH4FWDWKC2MBL4EBNKUV63T");
	...
	// Encrypt key setting ///////////////////////////////////////////////////////////////////////////////////////////
	encrypt_factory.setKey( 10, 31, strEncryptKeyData.operator LPCSTR() );
	...
	memcpy( randomindexstring, strSerialMergedtData.operator LPCTSTR(), 16 );
	...
	strSerialData+= strSerialIndexString;
...
{	
	...
	int i = 0 ; for(  i = 0; i < 26; i++ )
	{
		...
		int j = 0 ; for( j = (int)'0'; j <= (int)field[ fieldnumber ][fieldindex]; j++ )
		{
			if( fieldnumber == 0 )
			{
