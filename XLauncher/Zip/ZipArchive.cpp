...
//////////////////////////////////////////////////////////////////////
char CZipArchive::m_gszCopyright[] = {"Copyright"};
...
{
	char curPath[512];   /* Get the current working directory: */
	if (!_getcwd(curPath, 512))
		return false;
...
void CZipArchive::DeleteInternal(WORD uIndex)
{
	...
	if (uOtherOffsetChanged)
		int i = 0 ; for ( i = uIndex; i < GetNoEntries(); i++)
