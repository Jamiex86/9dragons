	...
	, m_htmlSection( &m_defaults )
{
	...
	m_hwnd = CreateWindowEx( WS_EX_TOPMOST| WS_EX_TOOLWINDOW, QHTM_TIP_WINDOW_CLASS, NULL, WS_POPUP | WS_BORDER, rcTip.left, rcTip.top, rcTip.Width(), rcTip.Height(), hwndParent, NULL, (HINSTANCE)GetWindowLong( hwndParent, GWL_HINSTANCE ) , this );
	VAPI( m_hwnd );
