...
{
public:
	CHTMLSectionCreator( CHTMLSection *psect, GS::CDrawContext &dc, int nTop, int nLeft, int nRight, COLORREF crBack, bool bMeasuring, int nZoomLevel, CHTMLSectionLink* pCurrentLink );
...
private:
	...
	MapClass<int, int>	m_mapBaseline;
