...
public:
	...
	//	Pagination Methods
	int Paginate(const WinHelper::CRect& rcPage);	// Returns number of pages
	...
	void SelectNearestLink( POINT pt );
...
private:
	...
	//
	//	Called whena  new document has been loaded
