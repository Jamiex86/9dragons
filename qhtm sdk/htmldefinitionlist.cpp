...
void CHTMLDefinitionList::AddDisplayElements( class CHTMLSectionCreator *psc )
{
	...
	for (UINT i = 0; i < nItems; ++i)
	{
		...
		CHTMLSectionCreator htCreate( psc->GetHTMLSection(), psc->GetDC(), psc->GetCurrentYPos(), nLeft, psc->GetRightMargin(), psc->GetBackgroundColor(), false, psc->GetZoomLevel(), psc->GetCurrentLink() );
