...
void CHTMLBlockQuote::AddDisplayElements( class CHTMLSectionCreator *psc )
{
	...
	*/
	...
	CHTMLSectionCreator htCreate( psc->GetHTMLSection(), psc->GetDC(), psc->GetCurrentYPos(), nLeft, nRight, psc->GetBackgroundColor(), false, psc->GetZoomLevel(), psc->GetCurrentLink() );
