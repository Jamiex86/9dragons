...
class NativeBitmap
{
  public:
	...
	int Height()		{ return height; }			//!< Height, in pixels
	int Width()			{ return width; }			//!< Width, , in pixels
	U8* Bits()			{ return bits; }			//!< Pointer to the base address of bitmap memory.
	...
	int Depth()			{ return depth; }			//!< The number of pixels per byte.
	...
	void UpdateFullTexture(  NativePlayerWnd*  );
