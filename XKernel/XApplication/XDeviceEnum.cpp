...
//-----------------------------------------------------------------------------
// Name: _XDeviceEnum constructor
// Desc: 
//-----------------------------------------------------------------------------
_XDeviceEnum::_XDeviceEnum()
{
...
//-----------------------------------------------------------------------------
HRESULT _XDeviceEnum::Enumerate()
{
    HRESULT hr;
...
//-----------------------------------------------------------------------------
HRESULT _XDeviceEnum::EnumerateDevices( D3DAdapterInfo* pAdapterInfo, 
                                           CArrayList* pAdapterFormatList )
{
    ...
    for( UINT idt = 0; idt < devTypeArrayCount; idt++ )
    {
		...
		// Skipping reference device
		if( devTypeArray[idt] == D3DDEVTYPE_REF )
		{
			delete pDeviceInfo;
            continue;
		}
...
//-----------------------------------------------------------------------------
HRESULT _XDeviceEnum::EnumerateDeviceCombos( D3DDeviceInfo* pDeviceInfo, 
                                               CArrayList* pAdapterFormatList )
{
...
//-----------------------------------------------------------------------------
void _XDeviceEnum::BuildDepthStencilFormatList( D3DDeviceCombo* pDeviceCombo )
{
...
//-----------------------------------------------------------------------------
void _XDeviceEnum::BuildMultiSampleTypeList( D3DDeviceCombo* pDeviceCombo )
{
...
//       multisample types.
//-----------------------------------------------------------------------------
void _XDeviceEnum::BuildDSMSConflictList( D3DDeviceCombo* pDeviceCombo )
{
...
//       and app to the given D3DDeviceCombo.
//-----------------------------------------------------------------------------
void _XDeviceEnum::BuildVertexProcessingTypeList( D3DDeviceInfo* pDeviceInfo, 
...
//-----------------------------------------------------------------------------
void _XDeviceEnum::BuildPresentIntervalList( D3DDeviceInfo* pDeviceInfo, 
                                                D3DDeviceCombo* pDeviceCombo )
{
    const UINT piArray[] = { 
