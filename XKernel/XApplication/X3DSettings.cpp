...
_X3DSettingsDialog* s_pSettingsDialog = NULL;
...
//-----------------------------------------------------------------------------
// Name: _X3DSettingsDialog constructor
// Desc: 
//-----------------------------------------------------------------------------
_X3DSettingsDialog::_X3DSettingsDialog( _XDeviceEnum* pEnumeration, 
                                        _X3DSettings* pSettings)
{
...
//-----------------------------------------------------------------------------
void _X3DSettingsDialog::ComboBoxAdd( int id, void* pData, TCHAR* pstrDesc )
{
...
//-----------------------------------------------------------------------------
void _X3DSettingsDialog::ComboBoxSelect( int id, void* pData )
{
    HWND hwndCtrl = GetDlgItem( m_hDlg, id );
...
// Desc: Selects an entry in the combo box.
//-----------------------------------------------------------------------------
void _X3DSettingsDialog::ComboBoxSelectIndex( int id, int index )
{
    HWND hwndCtrl = GetDlgItem( m_hDlg, id );
...
//-----------------------------------------------------------------------------
void* _X3DSettingsDialog::ComboBoxSelected( int id )
{
    HWND hwndCtrl = GetDlgItem( m_hDlg, id );
...
//       itemData is NULL.
//-----------------------------------------------------------------------------
bool _X3DSettingsDialog::ComboBoxSomethingSelected( int id )
{
    HWND hwndCtrl = GetDlgItem( m_hDlg, id );
    int index = ComboBox_GetCurSel( hwndCtrl );
    return ( index >= 0 );
...
//-----------------------------------------------------------------------------
UINT _X3DSettingsDialog::ComboBoxCount( int id )
{
    HWND hwndCtrl = GetDlgItem( m_hDlg, id );
...
//-----------------------------------------------------------------------------
void _X3DSettingsDialog::ComboBoxClear( int id )
{
    HWND hwndCtrl = GetDlgItem( m_hDlg, id );
...
//-----------------------------------------------------------------------------
bool _X3DSettingsDialog::ComboBoxContainsText( int id, TCHAR* pstrText )
{
    TCHAR strItem[200];
    HWND hwndCtrl = GetDlgItem( m_hDlg, id );
    UINT count = ComboBoxCount( id );
...
//-----------------------------------------------------------------------------
INT_PTR _X3DSettingsDialog::ShowDialog( HWND hwndParent )
{
...
//-----------------------------------------------------------------------------
INT_PTR _X3DSettingsDialog::DialogProc( HWND hDlg, UINT msg, WPARAM wParam, LPARAM lParam )
{
...
//-----------------------------------------------------------------------------
void _X3DSettingsDialog::AdapterChanged( void )
{
...
//-----------------------------------------------------------------------------
void _X3DSettingsDialog::DeviceChanged( void )
{
...
//       rest of the dialog.
//-----------------------------------------------------------------------------
void _X3DSettingsDialog::WindowedFullscreenChanged( void )
{
    D3DAdapterInfo* pAdapterInfo = (D3DAdapterInfo*)ComboBoxSelected( IDC_ADAPTER_COMBO );
    D3DDeviceInfo* pDeviceInfo = (D3DDeviceInfo*)ComboBoxSelected( IDC_DEVICE_COMBO );
...
//       of the dialog.
//-----------------------------------------------------------------------------
void _X3DSettingsDialog::AdapterFormatChanged( void )
{
    if( !IsDlgButtonChecked( m_hDlg, IDC_WINDOW ) )
    {
        D3DAdapterInfo* pAdapterInfo = (D3DAdapterInfo*)ComboBoxSelected( IDC_ADAPTER_COMBO );
...
//       refresh rate list.
//-----------------------------------------------------------------------------
void _X3DSettingsDialog::ResolutionChanged( void )
{
    if (m_d3dSettings.IsWindowed)
        return;
...
//-----------------------------------------------------------------------------
void _X3DSettingsDialog::RefreshRateChanged( void )
{
    if( m_d3dSettings.IsWindowed )
        return;
...
//-----------------------------------------------------------------------------
void _X3DSettingsDialog::BackBufferFormatChanged( void )
{
    D3DDeviceInfo* pDeviceInfo = (D3DDeviceInfo*)ComboBoxSelected( IDC_DEVICE_COMBO );
    D3DFORMAT adapterFormat = (D3DFORMAT)PtrToUlong( ComboBoxSelected( IDC_ADAPTERFORMAT_COMBO ) );
...
//-----------------------------------------------------------------------------
void _X3DSettingsDialog::DepthStencilBufferFormatChanged( void )
{
...
//-----------------------------------------------------------------------------
void _X3DSettingsDialog::MultisampleTypeChanged( void )
{
...
//-----------------------------------------------------------------------------
void _X3DSettingsDialog::MultisampleQualityChanged( void )
{
...
//-----------------------------------------------------------------------------
void _X3DSettingsDialog::VertexProcessingChanged( void )
{
...
//-----------------------------------------------------------------------------
void _X3DSettingsDialog::PresentIntervalChanged( void )
{
