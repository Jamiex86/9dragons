...
{
	int i = 0 ; for(; i < _MAX_TUTORIALCOUNT; i++ )
	{
...
{
	int windowid = 0 ; for( windowid = 40000; windowid < 40100; windowid++ )
	{
...
void _XWindow_Tutorial::Draw( _XGUIObject*& pfocusobject )
{
	...
	int i = 0 ; for(  i = 1; i < _MAX_TUTORIALCOUNT; i++ )
	{
