	...
	case ctrl_ch_item :
		{
			...
			{
				// 인벤토리 세팅
				g_pLocalUser->m_UserItemList[characsetting->item.useritem.cSlot].m_cType = characsetting->item.useritem.cType;
				g_pLocalUser->m_UserItemList[characsetting->item.useritem.cSlot].m_cSecond = characsetting->item.useritem.cSecond;
				...
				g_pLocalUser->m_UserItemList[characsetting->item.useritem.cSlot].m_cThird = _XGameItem::GetThird(characsetting->item.useritem.cType, characsetting->item.useritem.sID);
				g_pLocalUser->m_UserItemList[characsetting->item.useritem.cSlot].m_ucCount = characsetting->item.useritem.Item_Money.S_NormalItem.ucCount;		
				...
				{					
					g_pLocalUser->m_UserItemList[characsetting->item.useritem.cSlot].m_ucYear	= characsetting->item.useritem.uselimit.ucYear;	
					g_pLocalUser->m_UserItemList[characsetting->item.useritem.cSlot].m_ucMonth	= characsetting->item.useritem.uselimit.ucMonth;	
					g_pLocalUser->m_UserItemList[characsetting->item.useritem.cSlot].m_ucDay	= characsetting->item.useritem.uselimit.ucDay;	
					g_pLocalUser->m_UserItemList[characsetting->item.useritem.cSlot].m_ucHour	= characsetting->item.useritem.uselimit.ucHour;	
					g_pLocalUser->m_UserItemList[characsetting->item.useritem.cSlot].m_ucMinute	= characsetting->item.useritem.uselimit.ucMinute;
				}
			}
			else
			{
				// 창고 아이템 변경
				g_pLocalUser->m_WarehouseItemList[characsetting->item.useritem.cSlot].m_cType = characsetting->item.useritem.cType;
				g_pLocalUser->m_WarehouseItemList[characsetting->item.useritem.cSlot].m_cSecond = characsetting->item.useritem.cSecond;
				...
				g_pLocalUser->m_WarehouseItemList[characsetting->item.useritem.cSlot].m_cThird = _XGameItem::GetThird(characsetting->item.useritem.cType, characsetting->item.useritem.sID);
				g_pLocalUser->m_WarehouseItemList[characsetting->item.useritem.cSlot].m_ucCount = characsetting->item.useritem.Item_Money.S_NormalItem.ucCount;
				...
				if( characsetting->item.useritem.uselimit.ucYear > 0 )
				{					
					g_pLocalUser->m_WarehouseItemList[characsetting->item.useritem.cSlot].m_ucYear		= characsetting->item.useritem.uselimit.ucYear;	
					g_pLocalUser->m_WarehouseItemList[characsetting->item.useritem.cSlot].m_ucMonth		= characsetting->item.useritem.uselimit.ucMonth;	
					g_pLocalUser->m_WarehouseItemList[characsetting->item.useritem.cSlot].m_ucDay		= characsetting->item.useritem.uselimit.ucDay;	
					g_pLocalUser->m_WarehouseItemList[characsetting->item.useritem.cSlot].m_ucHour		= characsetting->item.useritem.uselimit.ucHour;	
					g_pLocalUser->m_WarehouseItemList[characsetting->item.useritem.cSlot].m_ucMinute	= characsetting->item.useritem.uselimit.ucMinute;
				}
			}
		}
		break;
